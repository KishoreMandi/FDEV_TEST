          ...
          <div className={`flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'}`}>
            ...
            <div className="flex gap-3">
              <button 
                ...
                className="group relative overflow-hidden flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium text-white bg-green-500 hover:bg-green-600 hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300"
              >
              ...
              <button 
                onClick={downloadPDF}
                className="group relative overflow-hidden flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium text-white bg-red-500 hover:bg-red-600 hover:shadow-lg hover:shadow-red-500/30 transition-all duration-300"
              >
